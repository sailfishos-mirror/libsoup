...
do_cookies_persistence_default_db_max_size_test (void)
{
	...
	guint max_size = soup_cookie_jar_db_get_max_size (SOUP_COOKIE_JAR_DB(jar));
...
do_cookies_persistence_db_max_size_storage_test (gconstpointer user_data)
{
	...
	guint sqlite_max_size = 0; // Our API sets zero for unlimited
	guint max_size_read = soup_cookie_jar_db_get_max_size (SOUP_COOKIE_JAR_DB(jar));
...
do_cookies_persistence_db_max_size_at_object_creation_storage_test (gconstpointer user_data)
{
	...
	guint sqlite_max_size = 0;
	guint max_size_read = G_MAXUINT;
...
typedef struct {
	guint size_requested1;
	guint notify_count_expected1;
	guint size_requested2;
